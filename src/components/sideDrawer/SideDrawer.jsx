...
const SideDrawer = ({ backDropClickHandler, toggleDrawer }) => {
    ...
    return(
        <nav className={ drawerClasses }>
            ...
            <ul>
                <li>
                    <Link to={ROUTES.MENS_COLLECTION} onClick={ backDropClickHandler }>Mens</Link>
                </li>
                <li>
                    <Link to={ROUTES.WOMENS_COLLECTION} onClick={ backDropClickHandler }>Womens</Link>
                </li>
                <li>
                    <Link to={ROUTES.KIDS_COLLECTION} onClick={ backDropClickHandler }>Kids</Link>
                </li>
                <li>
